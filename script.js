...
function createScene() {
  ...
  scene.fog = new THREE.FogExp2(0xcdc1c5 , 0.09);
  ...
  renderer.setClearColor(0xcdc1c5 , 1);
  ...
  titleText.innerHTML = "Shinigami World";
...
function createTree() {
  ...
  //blowUpTree(treeGeometry.vertices, sides, 5, scalarMultiplier * 1.1, true);
  //tightenTree(treeGeometry.vertices, sides, 5);
...
// tightenTree(treeGeometry.vertices, sides, 5);
  ...
  var treeTrunkGeometry = new THREE.CylinderGeometry(0.4, 0.9, 0.7);
